...
This project is also a little hardware intensive along with the software part as proper calibration, correct positioning of different components and code testing needs to be at various steps without which moving forwards is not quite possible. Hardware testing would be done by the mentors and mentees who would be in the insti during the summer vacations. 
